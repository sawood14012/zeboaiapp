...
class _MyHomePageState extends State<MyHomePage> with TickerProviderStateMixin {
  ...
  String name = "";
  var cardsList = [
    CardItemModel("Eat Healthy always", Icons.account_circle, 9, 0.83),
    CardItemModel("Try to workout everyday", Icons.work, 12, 0.24),
    CardItemModel("Sleep Well", Icons.home, 7, 0.32)
  ];
